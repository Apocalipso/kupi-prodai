          ...
          <div class="ticket-card ticket-card--color01">
            ...
            <div class="ticket-card__info">
              ...
              <div class="ticket-card__header">
                <h3 class="ticket-card__title"><a href="<?= Url::to(['/offers/view', 'id' => $publication->id]);?>"><?=$publication->title?></a></h3>
        ...
        <li class="tickets-list__item">
          <div class="ticket-card ticket-card--color09">
            ...
            <?php endif;?>
              ...
              <div class="ticket-card__header">
                <h3 class="ticket-card__title"><a href="<?= Url::to(['/offers/view', 'id' => $comment->publication->id]);?>"><?=$comment->publication->title;?></a></h3>
